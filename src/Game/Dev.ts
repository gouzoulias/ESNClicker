...
export const DevInitialInfos: Record<Dev, ProductionItemInfo> = {
  [Dev.Stagiaire]: {
    description: 'Un stagiaire qui fait du code',
    name: 'Stagiaire',
    productivity: 1,
    price: 500,
    numberOwned: 0,
  ...
  [Dev.Alternant]: {
    description: 'Un alternant qui fait du code',
    name: 'Alternant',
    numberOwned: 0,
    price: 1500,
    productivity: 5,
  ...
  [Dev.Integrateur]: {
    description: 'Un intégrateur qui fait du code',
    name: 'Intégrateur',
    numberOwned: 0,
    price: 2000,
    productivity: 10,
  ...
  [Dev.FullStackJunior]: {
    description: 'Un fullstack junior qui fait du code',
  ...
  [Dev.FullStackSenior]: {
    description: 'Un fullstack senior qui fait du code',
  ...
  [Dev.Lead]: {
    description: 'Un lead qui fait du code',
    name: 'Lead',
    numberOwned: 0,
    price: 4000,
    productivity: 50,
  ...
  [Dev.Architecte]: {
    description: 'Un architecte qui fait du code',
    name: 'Architecte',
    numberOwned: 0,
    price: 5000,
    productivity: 100,
  ...
  [Dev.CTO]: {
    description: 'Un CTO qui fait du code',
    name: 'CTO',
    numberOwned: 0,
    price: 7000,
    productivity: 150,
